...
function New-YcIAMSCIMRequest
{
    param (
        ...
        if (!($AttributeMapping))
        {
            throw ("AttributeMapping is empty for some reason need to abort. Check PathToMappingFile Parameter.")
        }
...
function New-YcIAMCsvFromMapping {
    ...
    Set-Content -Path $OutputCSVPath -Value $headerLine -Encoding UTF8
